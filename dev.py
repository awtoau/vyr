...
def cmd_microbench(rest: list[str]) -> int:
    # #37/#63: the ~200-point painter micro-benchmark landscape → SQLite.
    # DIAGNOSTIC, gates nothing. --deep adds the {int,mem,hw-f32,soft-f64}
    # class split (soft-f64 = the determinism tax, #63).
    return _run(["python3", "scripts/microbench.py", *rest])
